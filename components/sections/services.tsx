...
const services = [
  {
    ...
    description:
      "Sitios modernos y rápidos que generan confianza desde el primer clic. Código a la medida, no plantillas genéricas.",
  },
  {
    icon: Paintbrush,
    number: "02",
    title: "Diseño UI/UX",
    description:
      "Interfaces pensadas para convertir. Cada botón, color y espacio tiene una razón estratégica.",
  },
  {
    icon: Search,
    number: "03",
    ...
    description:
      "Aparece primero en Google cuando tu cliente ideal te busca. SEO técnico y de contenido.",
  },
  {
    icon: ShoppingCart,
    number: "04",
    ...
    description:
      "Vende las 24 horas. Catálogo, carrito y pagos integrados con experiencia de compra optimizada.",
  },
  {
    icon: Bot,
    number: "05",
  ...
  },
  {
    ...
    description:
      "Conoce exactamente de dónde vienen tus clientes y qué los convierte. Decisiones con datos reales.",
  },
  {
    icon: Layers,
    number: "07",
    ...
    description:
      "Portales de clientes, cotizadores y dashboards que se adaptan a tus procesos únicos de negocio.",
  },
  {
    icon: Smartphone,
    number: "08",
  ...
  },
  {
    ...
    description:
      "Un sitio lento pierde clientes antes de que lean tu propuesta. Cargamos en menos de 2 segundos.",
  },
  {
    icon: RefreshCw,
    number: "10",
    title: "Rediseño Web",
    description:
      "Modernizamos tu sitio sin perder tu identidad ni el SEO que ya acumulaste.",
  },
  {
    icon: Shield,
    number: "11",
    ...
    description:
      "Backups automáticos, actualizaciones y monitoreo continuo. Tu web siempre arriba y protegida.",
  },
]
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl text-balance">
            ...
            <span className="text-primary">necesita para dominar</span>
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground leading-relaxed">
            Desde el diseño hasta la automatización con IA — cubrimos cada
            aspecto de tu presencia digital.
          </p>
        </div>
      </div>
        ...
        >
          {services.map((s) => {
            ...
            return (
              <div
                key={s.number}
                className="group relative flex shrink-0 flex-col overflow-hidden rounded-2xl border border-border bg-card p-8 transition-all duration-300 hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/8 hover:-translate-y-2"
