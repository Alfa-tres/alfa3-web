...
const items = [
  {
    ...
    description: "Los primeros 3 segundos deciden si un cliente se queda o se va. Construimos sitios que cargan en menos de 2 segundos y convierten desde el primer clic.",
  ...
  },
  {
    ...
    description: "Una página web no es un gasto. Es el vendedor más rentable que tendrás: trabaja sin parar, no pide vacaciones y escala sin contratar más personal.",
  ...
  },
  {
    ...
    description: "No basta con verse bien. Cada sección, cada botón y cada llamada a acción está diseñada para guiar a tu visitante hacia una conversión. Sin decoración vacía.",
    colSpan: "lg:col-span-1",
    featured: false,
    wide: false,
  },
  {
    ...
    description: "Antes de escribir una línea de código, entendemos tu mercado, tu competencia y tus objetivos. Cada decisión tiene una razón estratégica detrás.",
    colSpan: "lg:col-span-2",
    featured: false,
    wide: false,
  },
  {
    ...
    description: "El lanzamiento es solo el inicio. Monitoreamos, ajustamos y mejoramos tu sitio continuamente para que siga generando resultados mes a mes.",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="animate-fade-up mb-14 text-center">
          ...
          <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl lg:text-5xl text-balance">
            No hacemos páginas web.{" "}<span className="text-primary">Creamos resultados.</span>
          </h2>
        </div>
