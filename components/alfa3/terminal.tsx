...
const commandResponses: Record<string, TerminalLine[]> = {
  "./servicios": [
    ...
    { type: "success", text: "[03] Optimizacion & Performance" },
    { type: "success", text: "[04] Rediseno Web" },
  ...
  "./estrategia": [
    ...
    { type: "output", text: "" },
    { type: "success", text: "PASO 1: Analisis & Diagnostico" },
    { type: "success", text: "PASO 2: Diseno Estrategico" },
    { type: "success", text: "PASO 3: Desarrollo con IA & Mejores Practicas" },
    { type: "success", text: "PASO 4: Lanzamiento & Evolucion" },
    { type: "output", text: "" },
    { type: "info", text: "+50 Proyectos | 99.9% Uptime | 98% Satisfaccion" },
  ],
  "./contacto": [
    { type: "info", text: ">> Abriendo canal de comunicacion..." },
    { type: "success", text: "Redirigiendo a WhatsApp..." },
    { type: "link", text: ">> Click aqui si no se redirige automaticamente", href: WHATSAPP_URL },
  ],
}
